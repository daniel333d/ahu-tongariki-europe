...
export function MasterplanMap({ activeId, onSelect }: MasterplanMapProps) {
  ...
  return (
    <div
      className="relative min-h-[380px] overflow-hidden rounded-lg border border-white/12 bg-[#061017] shadow-[0_30px_90px_rgba(0,0,0,0.4),inset_0_1px_0_rgba(255,255,255,0.06),inset_0_0_1px_rgba(217,180,97,0.12)] 2xl:min-h-[340px]"
