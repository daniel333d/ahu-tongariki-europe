...
const categoryLabels: Record<MasterplanObject["category"], string> = {
  museum: "Muzeum",
      ...
      >
        ...
        <div className="mt-5 grid grid-cols-3 gap-4 border-y border-white/10 py-4">
          <div>
            ...
            <p className="text-white/46 mt-1 text-[0.66rem] uppercase tracking-[0.14em]">Czas zwiedzania</p>
          </div>
          <div>
            ...
            <p className="text-white/46 mt-1 text-[0.66rem] uppercase tracking-[0.14em]">Pojemność</p>
          </div>
          <div>
            <GalleryVerticalEnd
            ...
            <p className="text-white/46 mt-1 text-[0.66rem] uppercase tracking-[0.14em]">Charakter</p>
          </div>
        </div>
